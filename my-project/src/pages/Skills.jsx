    ...
    <div className="lg:container lg:mx-auto">
      ...
      <div className="flex justify-center mt-10 gap-20 h-[700px]">
        <div className="flex gap-7 items-center w-[1400px] ">
          <div className="w-1/3 flex items-center h-18 bg-metal px-4 py-4 rounded-xl gap-3 drop-shadow-md animate__animated animate__fadeInUp">
          ...
          <div className="w-1/3 flex items-center h-18 bg-metal px-4 py-4 rounded-xl gap-3 drop-shadow-md animate__animated animate__fadeInUp animate__delay-1s">
          ...
          <div className="w-1/3 flex items-center h-18 bg-metal px-4 py-4 rounded-xl gap-3 drop-shadow-md animate__animated animate__fadeInUp animate__delay-2s">
